...
import { StyleSheet, Text, View, TouchableOpacity, ImageBackground, Image, SafeAreaView, ScrollView, TextInput } from 'react-native';

import { EvilIcons, Octicons, Ionicons , MaterialIcons, MaterialCommunityIcons} from '@expo/vector-icons';
      ...
      <ScrollView>
          ...
          {/*   Top of the screen    */}
            <View style={styles.top}>
              <ImageBackground source={require('../assets/Musee.png')} resizeMode="cover" style={styles.image} imageStyle={{ borderRadius: 20}}>
          ...
          {/*   horaires rt moyenne de transport part    */}
            ...
            <View style={styles.row}>
              <View style={styles.row1}>
                <MaterialIcons name="emoji-transportation" size={width/12} color="#E17E01" />
                <Text style={styles.bText}>Moyenne de transport</Text>
              </View>
              <View style={styles.row2}>
                <Ionicons name="ios-car-sport-outline" size={width/15} color="#E17E01" />
                <Ionicons name="subway-outline" size={width/15} color="#E17E01" />
                <Ionicons name="md-airplane-outline" size={width/15} color="#E17E01" />
              </View>
            ...
            <View>
              <View style={styles.galerie}>
                <Image source={require('../assets/Musee.png')} style={styles.Igalerie} />
                <Image source={require('../assets/Musee.png')} style={styles.Igalerie} />
                <Image source={require('../assets/musee.png')} style={styles.Igalerie} />
              </View>
              <View style={styles.galerie}>
              ...
              <View style={styles.galerie}>
                ...
                <ImageBackground source={require('../assets/Musee.png')} style={styles.Igalerie} blurRadius={15} imageStyle={{ borderRadius: 10}}>
            ...
            {/*  ajouter onPress pour le retour de page  */}
              <TouchableOpacity>
                <MaterialCommunityIcons name="arrow-left-circle" size={width/8.5} color="#E17E01" />
              </TouchableOpacity>
